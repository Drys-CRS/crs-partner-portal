    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col">
      ...
      <header className="border-b border-slate-800 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/signup"
            className="text-sm px-4 py-2 rounded-lg bg-amber-600 hover:bg-amber-500 text-white font-semibold transition-colors">
            Apply for access
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-20 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-900/40 border border-amber-700/50 text-amber-400 text-xs font-medium mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/signup"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-amber-600 hover:bg-amber-500 text-white font-semibold transition-colors text-sm">
            Become a Partner
            <ArrowRight className="h-4 w-4" />
          </Link>
          <Link href="/login"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl border border-slate-700 hover:border-amber-700 text-slate-300 hover:text-white font-semibold transition-colors text-sm">
            Partner Sign In
          </Link>
        </div>
      </main>
      ...
      <section className="border-t border-slate-800 px-6 py-16">
        <div className="max-w-4xl mx-auto grid sm:grid-cols-3 gap-8">
          <Feature icon={<FileText className="h-5 w-5 text-amber-400" />} title="Tiered Resources">
            Access sales decks, technical briefs, and marketing collateral matched to your partner tier.
          </Feature>
          <Feature icon={<BarChart3 className="h-5 w-5 text-amber-400" />} title="Deal Intelligence">
            Stay ahead with market insights and competitive positioning content reserved for CRS partners.
          </Feature>
          <Feature icon={<Lock className="h-5 w-5 text-amber-400" />} title="Secure Access">
...
function Feature({ icon, title, children }: { icon: React.ReactNode; title: string; children: React.ReactNode }) {
  return (
    <div className="flex flex-col gap-3">
      <div className="w-9 h-9 rounded-lg bg-slate-800 border border-amber-900/40 flex items-center justify-center">
        {icon}
      </div>
